...
#very_short_list <- pathids[1:5]
#very_short_list <- c('05200')
...
frec_anz <- data.frame(Gene_name = gene, n_path = freq)
 ...
 ggplot(frec_anz ,aes(reorder(Gene_name, -n_path),n_path, fill = Gene_name)) + 
